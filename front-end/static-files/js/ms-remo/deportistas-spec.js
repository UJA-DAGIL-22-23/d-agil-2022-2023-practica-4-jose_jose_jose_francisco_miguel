...
describe("Deportistas.AlmacenaObjetos", function () {
    it('Debería guardar el deportista', function () {
        ...
        expect(Deportistas.deportistaMostrado.ref['@ref'].id).toBe(d1.ref['@ref'].id)
    });
    it('Debería guardar el vector', function () {
        Deportistas.almacenaVector([d1,d2])
        expect(Deportistas.vectorDeportistas[0].ref['@ref'].id).toBe(d1.ref['@ref'].id)
        expect(Deportistas.vectorDeportistas[1].ref['@ref'].id).toBe(d2.ref['@ref'].id)
    });
});
